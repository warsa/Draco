...
#MSUB -j oe
#MSUB -o /usr/projects/draco/draco-6_11_0/logs/release_ct_build.log

#----------------------------------------------------------------------#
# The script starts here
#----------------------------------------------------------------------#

echo "Here we go..." > /usr/projects/draco/draco-6_11_0/logs/release_ct_build.log
...
MAKE="make -j48"
CONFIG_BASE="-DDRACO_VERSION_PATCH=1"
CC=`which cc`
CXX=`which CC`
FC=`which ftn`
printenv
