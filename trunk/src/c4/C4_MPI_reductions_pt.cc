...
template DLL_PUBLIC_c4 void global_prod< unsigned long long >( unsigned long long &);
...
template DLL_PUBLIC_c4 void global_sum< unsigned long long >( unsigned long long *, int);
...
template DLL_PUBLIC_c4 void global_prod< unsigned long long >( unsigned long long *, int);
...
template DLL_PUBLIC_c4 void global_max< unsigned long long >( unsigned long long *, int);
...
template DLL_PUBLIC_c4 void global_min< unsigned long long >( unsigned long long *, int);
