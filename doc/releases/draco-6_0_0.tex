...
\begin{figure}
  \label{fig:level}
  \centerline{
    \includegraphics[height=5.5in]{level-6_0_0.pdf}}
...
\begin{figure}
  \label{fig:stats}
  \centerline{
    \includegraphics[width=6in]{draco600-loc-history.pdf}}
...
One additional build directory named \texttt{debug\_verbose} may also
be found on some platforms.  For \draco\ this build is identical to
\texttt{debug}.  For \textsc{Wedgehog}, this build is extra-verbose
