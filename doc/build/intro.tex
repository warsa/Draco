...
\begin{table}
  \begin{center}
    ...
    \begin{tabular}{lp{4in}}\hline\hline
  	...
  	\hline \hline
      \multicolumn{2}{p{0.85\linewidth}}{$^a$The \draco\ team is considering adoption of Redmine for Wiki and Tracker support.  The location of this tool is \url{http://coder.lanl.gov/redmine} } \\
    \end{tabular}
  \end{center}
