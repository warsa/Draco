...
if (BLA_VENDOR MATCHES "Intel*" OR BLA_VENDOR STREQUAL "All")
   ...
   if (_LANGUAGES_ MATCHES C OR _LANGUAGES_ MATCHES CXX)
      ...
      if (WIN32)
         ...
         if (BLA_VENDOR STREQUAL "Intel10_64lp_gf_sequential" OR BLA_VENDOR STREQUAL "All")
            ...
            if(BLA_F95)
               if(NOT BLAS95_LIBRARIES)
                  check_fortran_libraries(
                     ...
                     sgemm
                     ""
                     "mkl_blas95;mkl_gf_lp64;mkl_sequential;mkl_core"
                     "${CMAKE_THREAD_LIBS_INIT};${LM}"
                     )
               endif(NOT BLAS95_LIBRARIES)
            else(BLA_F95)
               if(NOT BLAS_LIBRARIES)
                  check_fortran_libraries(
                     ...
                     sgemm
                     ""
                     "mkl_gf_lp64;mkl_core;mkl_sequential"
                     "${CMAKE_THREAD_LIBS_INIT};${LM}"
                     )
               endif(NOT BLAS_LIBRARIES)
            endif(BLA_F95)
         endif (BLA_VENDOR STREQUAL "Intel10_64lp_gf_sequential" OR BLA_VENDOR STREQUAL "All")
