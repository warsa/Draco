...
void runTest( rtt_dsxx::UnitTest & ut )
{
    ...
    type_list.push_back(Element_Definition::QUAD_6);
    ...
    for (size_t i=0; i< type_list.size(); i++)
    {
        ...
        if( ! elem_defs.back().invariant_satisfied() )
        {
            ...
            msg << "invariant_satisfied() failed for element i="
                << i << ", whose type is = " << elem_defs.back().get_name()
                << std::endl;
            FAILMSG(msg.str());
        }
    }
    ...
    rtt_mesh_element_test::test_node(ut,elem_defs.front());      elem_defs.pop_front();
    rtt_mesh_element_test::test_bar_2(ut,elem_defs.front());     elem_defs.pop_front();
    rtt_mesh_element_test::test_bar_3(ut,elem_defs.front());     elem_defs.pop_front(); 
    rtt_mesh_element_test::test_tri_3(ut,elem_defs.front());     elem_defs.pop_front();
    rtt_mesh_element_test::test_tri_6(ut,elem_defs.front());     elem_defs.pop_front();
    rtt_mesh_element_test::test_quad_4(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_quad_5(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_quad_6(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_quad_7(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_quad_8(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_quad_9(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_tetra_4(ut,elem_defs.front());   elem_defs.pop_front();
    rtt_mesh_element_test::test_tetra_10(ut,elem_defs.front());  elem_defs.pop_front();
    rtt_mesh_element_test::test_pyra_5(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_pyra_14(ut,elem_defs.front());   elem_defs.pop_front();
    rtt_mesh_element_test::test_penta_6(ut,elem_defs.front());   elem_defs.pop_front();
    rtt_mesh_element_test::test_penta_15(ut,elem_defs.front());  elem_defs.pop_front();
    rtt_mesh_element_test::test_penta_18(ut,elem_defs.front());  elem_defs.pop_front();
    rtt_mesh_element_test::test_hexa_8(ut,elem_defs.front());    elem_defs.pop_front();
    rtt_mesh_element_test::test_hexa_20(ut,elem_defs.front());   elem_defs.pop_front();
    rtt_mesh_element_test::test_hexa_27(ut,elem_defs.front());   elem_defs.pop_front();
    ...
    vector<Element_Definition> p_elem_defs;
    p_elem_defs.push_back(Element_Definition(Element_Definition::BAR_2));

    vector<int> p_side_type(8,  // number of sides
                            0); // index into elem_defs
    
    vector<vector<size_t> > p_side_nodes(8);
    for (unsigned side=0; side<8; ++side)
    {
        p_side_nodes[side].push_back(side);
        p_side_nodes[side].push_back((side+1)%8);
    }
                 ...
                 const rtt_mesh_element::Element_Definition elem_def)
{
    ...
    ldum = ldum && elem_def.get_type() == Element_Definition::QUAD_6;
    ldum = ldum && elem_def.get_number_of_nodes() == 6;
    ldum = ldum && elem_def.get_dimension() == 2;
    ldum = ldum && elem_def.get_number_of_sides() == 4;
