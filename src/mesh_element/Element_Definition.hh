...
public:
  ...
  enum Element_Type {
    ...
    QUAD_8,     /*!< A quad with nodes in the center of all four faces. This
                 *   is standard quadratic-serendipity finite element quad.*/
    ...
    HEXAGON_6,  /*!< The basic two-D, six-node "hexagon" element.  Elements
                 *   with this topology are quite common in an AMR mesh. */
    ...
    TETRA_10,   /*!< Same as "TETRA_4" except that a node is added in the
                 *   middle of each edge. This is the standard
                 *   quadratic-serendipity finite element tet.*/
    PYRA_5,     /*!< The basic three-D, five-node, "pyramid" element.  This
                 *   is a hex with one face collapsed to a point.*/
    PYRA_14,    /*!< Same as "PYRA_5" except that a node is added on each
                 *    edge, and one at the center. */
    PENTA_6,    /*!< The basic three-D, six-node "pentahedron". Also known as
                 *   a "triangular-prism", or "wedge". */
    PENTA_15,   /*!< Same as "PENTA-6" except that nodes are added in the
                 *   center of each edge. This is the standard
                 *   quadratic-serendipity finite element wedge.*/
    ...
    HEXA_20,    /*!< Same as "HEXA_8" except that a node is added in the
                 *   center of each edge. This is the standard
                 *   quadratic-serendipity finite element hex.*/
    HEXA_27,    /*!< Same as "HEXA_20" except that a node is added in the
                 *   center of each face, and at the center of the element.
                 */
