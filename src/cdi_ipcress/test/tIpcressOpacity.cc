...
void file_check_Al_BeCu()
{
    ...
    SP<IpcressFile> spGFABC;
	    
    // Attempt to instantiate the object.
    try
    {
	spGFABC = new IpcressFile( op_data_file ); 
    }
    ...
    //         spGFABC, matid, rtt_cdi::ROSSELAND, rtt_cdi::TOTAL );
    // }
    // catch ( const rtt_cdi_ipcress::IpcressException& GandError )
    // {
    //     ostringstream message;
    //     message << "Failed to create SP to new IpcressOpacity object for "
    //     	<< "Al_BeCu.ipcress data."
...
//     }
//     catch (const rtt_cdi_ipcress::gmatidsException& GandError)
//     {
// 	ostringstream message;
...
// 				    cvdensity.end(), 
// 				    graOp.begin() );
//     if ( rtt_cdi_ipcress_test::match( graOp, vtabulatedGrayOpacity ) )
//     {
// 	ostringstream message;
...
//     if ( rtt_cdi_ipcress_test::match( mgOp, vtabulatedOpacity ) )
//     {
// 	ostringstream message;
...
// {
//     using namespace rtt_cdi_ipcress;
...
//             "Unknown error returned from Ipcress::ggetmg()." );
//         try
//         {
//             all_ok=false;
...
//     { 
//         std::string const expectedMsg(
//             "Unknown error returned from Ipcress::ggetgray()." );
//         try
//         {
//             all_ok=false;
...
//     { 
//         std::string const expectedMsg(
//             "Unknown error returned from Ipcress::gmatids()." );
//         try
//         {
//             all_ok=false;
...
//     { 
//         std::string const expectedMsg(
//             "Unknown error returned from Ipcress::gchgrids()." );
//         try
//         {
//             all_ok=false;
...
//     { 
//         std::string const expectedMsg(
//             "Unknown error returned from Ipcress::gkeys()." );
//         try
//         {
//             all_ok=false;
...
//     // Check the IpcressException base class
//     {
...
//         {
//             all_ok=false;
//             throw IpcressException( dummyMsg );
//         }
//         catch( IpcressException const & error)
//         {
//             PASSMSG("Caught an expected exception");
//             msg     = error.getErrorMessage();
//             gfn     = error.getIpcressFunctionName();
