...
template DLL_PUBLIC_c4 int send<unsigned char>(const unsigned char *, int, int, int);
template DLL_PUBLIC_c4 int send<short>(const short *, int, int, int);
template DLL_PUBLIC_c4 int send<unsigned short>(const unsigned short *, int, int, int);
template DLL_PUBLIC_c4 int send<int>(const int *, int, int, int);
template DLL_PUBLIC_c4 int send<unsigned int>(const unsigned int *, int, int, int);
...
template DLL_PUBLIC_c4 int send<unsigned long>(const unsigned long *, int, int, int);
template DLL_PUBLIC_c4 int send<unsigned long long>(const unsigned long long *, int, int, int);
...
template DLL_PUBLIC_c4 int send<long double>(const long double *, int, int, int);

template DLL_PUBLIC_c4 int send_udt<double>(const double *, int, int, C4_Datatype &, int);    

template DLL_PUBLIC_c4 int receive<char>(char *, int, int, int);
template DLL_PUBLIC_c4 int receive<unsigned char>(unsigned char *, int, int, int);
template DLL_PUBLIC_c4 int receive<short>(short *, int, int, int);
template DLL_PUBLIC_c4 int receive<unsigned short>(unsigned short *, int, int, int);
...
template DLL_PUBLIC_c4 int receive<unsigned long>(unsigned long *, int, int, int);
template DLL_PUBLIC_c4 int receive<unsigned long long>(unsigned long long *, int, int, int);
...
template DLL_PUBLIC_c4 int receive_udt<double>(double *, int, int, C4_Datatype &, int); 
...
template DLL_PUBLIC_c4 int broadcast<unsigned short>(unsigned short *, int, int);
...
template DLL_PUBLIC_c4 int broadcast<unsigned long long>(unsigned long long *, int, int);
