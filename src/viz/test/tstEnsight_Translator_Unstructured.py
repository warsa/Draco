...
try:
  ...
  for var in vars:
    ...
    tEnsight_Translator.diff_two_files("PROJECT_BINARY_DIR", \
      "unstr2d_testproblem_ensight/{0}/data.0001".format(var), "PROJECT_SOURCE_DIR", \
      "unstr2d_bench/{0}.0001".format(var))
  ...
  if tEnsight_Translator.is_little_endian():
    ...
    for var in vars:
      ...
      tEnsight_Translator.diff_two_files( "PROJECT_BINARY_DIR", \
        "unstr2d_testproblem_binary_ensight/{0}/data.0001".format(var), \
        "PROJECT_SOURCE_DIR", "unstr2d_bench/{0}.bin.0001".format(var), \
        diff_name=diff_prog)
