...
// Failure functions also set rtt_timestep_test::passed to false
...
// (rtt_timestep_test::passed will have its default value of true)
...
#define ITFAILS    rtt_timestep_test::fail(__LINE__);
#define FAILURE    rtt_timestep_test::fail(__LINE__, __FILE__);
#define PASSMSG(a) rtt_timestep_test::pass_msg(a);
#define FAILMSG(a) rtt_timestep_test::fail_msg(a);
