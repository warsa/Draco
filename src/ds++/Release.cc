 ...
 * \note   Copyright (C) 1999-2014 Los Alamos National Security, LLC.
 *         All rights reserved.
 */
//---------------------------------------------------------------------------//
// $Id$
...
//            01234567890123456789012345678901234567890123456789012345678901234567890123456789
    alist << "    Kelly G. Thompson, Kent G. Budge, Tom M. Evans, B. Todd Adams,\n"
          << "    Gabriel M. Rockefeller, Rob Lowrie, John McGhee, Mike W. Buksas,\n"
...
const std::string copyright()
{
    ...
    msg << "Draco Contributers: \n"
        << author_list() << "\n\n"
        << "Copyright (C) 1995-2014 Los Alamos National Security, LLC."
        << std::endl;
