...
// Failure functions also set rtt_ode_test::passed to false
...
// (rtt_ode_test::passed will have its default value of true)
...
#define ITFAILS      rtt_ode_test::fail(__LINE__);
#define FAILURE      rtt_ode_test::fail(__LINE__, __FILE__);
#define PASSMSG(a)   rtt_ode_test::pass_msg(a);
#define FAILMSG(a)   rtt_ode_test::fail_msg(a);
#define UNIT_TEST(x) rtt_ode_test::unit_test(x, __LINE__, __FILE__)
    
#endif // ode_test_hh

//---------------------------------------------------------------------------//
//     end of ode/ode_test.hh
//---------------------------------------------------------------------------//
