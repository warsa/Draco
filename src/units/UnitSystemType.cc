...
UnitSystemType::UnitSystemType( Ltype myL, Mtype myM, ttype myt, 
...
UnitSystemType& UnitSystemType::L( Ltype               myType, 
				   double      const * cf,
...
UnitSystemType& UnitSystemType::M( Mtype myType, 
				   double const * cf,
				   std::string const & labels ) 
{
...
UnitSystemType& UnitSystemType::t( ttype myType, 
				   double const * cf,
				   std::string const & labels ) 
{
...
UnitSystemType& UnitSystemType::I( Itype myType, 
				   double const * cf,
				   std::string const & labels ) 
{ 
...
UnitSystemType& UnitSystemType::A( Atype myType, 
				   double const * cf,
				   std::string const & labels ) 
{
...
UnitSystemType& UnitSystemType::Q( Qtype myType, 
				   double const * cf,
				   std::string const & labels )
{
